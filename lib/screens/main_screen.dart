...
class _MenuGrid extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final items = <_MenuItem>[
      _MenuItem(label: '회화', sub: 'Разговор', badge: 'Ch', color: AppColors.rojo,
        builder: (_) => const ConversationScreen()),
      _MenuItem(label: '문법', sub: 'Грамматика', badge: 'G', color: AppColors.rojoDeep,
        builder: (_) => const GrammarHubScreen()),
      _MenuItem(label: '문장 카드', sub: 'Фразы', badge: 'S', color: AppColors.tinta,
        builder: (_) => const SentenceFlashcardScreen()),
      _MenuItem(label: '말하기', sub: 'Речь', badge: '🎙', color: AppColors.rojo,
        builder: (_) => const SpeakingPracticeScreen()),
      _MenuItem(label: '청크 검색', sub: 'Поиск', badge: '🔍', color: AppColors.gualdaDeep,
        builder: (_) => const ChunkSearchScreen()),
      _MenuItem(label: '단어', sub: 'Слова', badge: 'W', color: AppColors.oliva,
        builder: (_) => const TopicVocabScreen()),
      _MenuItem(label: '표현', sub: 'Выражения', badge: 'E', color: AppColors.rojoLight,
        builder: (_) => const TopicVocabScreen(
            title: '주제별 표현',
            asset: 'assets/data/vocab/travel_expressions.json')),
      _MenuItem(label: '빈도 단어', sub: 'Частота', badge: 'F', color: AppColors.gualda,
        builder: (_) => const WordFreqScreen()),
      _MenuItem(label: '발음', sub: 'Произношение', badge: 'rr', color: AppColors.er,
        builder: (_) => const _ComingSoon(title: '발음 (rr · ñ · 강세)')),
      _MenuItem(label: '단어 카드', sub: 'Карточки', badge: 'R', color: AppColors.gualdaDeep,
