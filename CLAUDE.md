# CLAUDE.md — talkverselab/talkverse-ru
...
- 이름은 **`talkverselab/talkverse-<언어코드>`** 로 통일(2026-09-10). 옛 이름(`ru-universe` 등)은 리다이렉트되지만
  remote는 새 이름으로 바꿔 둘 것: `git remote set-url origin https://github.com/talkverselab/talkverse-ru.git`
...
- **이전 코드·자산은 `talkverse/_legacy/ru/`** 에 그대로 있다(리포 밖). git 이력에도 남아 있다.
- 옮긴 콘텐츠: 러시아어 회화 18편(144턴, 편마다 반전) · 떠먹여주는 문장 600(문법 2~7강 + 표현) · 단계별 예문 35 · 기초 명사 50
